...
public final class ActivityMainBinding implements ViewBinding {
  ...
  private ActivityMainBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView bgImage,
      @NonNull TextView footerText, @NonNull MaterialButton loginButton,
      @NonNull ImageView logoImage, @NonNull TextInputEditText passwordInput,
      @NonNull TextInputLayout passwordLayout, @NonNull TextInputEditText usernameInput,
      @NonNull TextInputLayout usernameLayout, @NonNull TextView welcomeText) {
  ...
  public static ActivityMainBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMainBinding((ConstraintLayout) rootView, bgImage, footerText, loginButton,
