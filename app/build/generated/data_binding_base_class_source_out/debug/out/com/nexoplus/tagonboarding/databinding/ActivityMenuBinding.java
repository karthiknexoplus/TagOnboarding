...
public final class ActivityMenuBinding implements ViewBinding {
  ...
  private ActivityMenuBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView bgImage,
      @NonNull TextView footerText, @NonNull ImageView logoImageMenu,
      @NonNull ImageButton logoutButton, @NonNull RecyclerView menuRecyclerView) {
  ...
  public static ActivityMenuBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityMenuBinding((ConstraintLayout) rootView, bgImage, footerText,
          logoImageMenu, logoutButton, menuRecyclerView);
    }
