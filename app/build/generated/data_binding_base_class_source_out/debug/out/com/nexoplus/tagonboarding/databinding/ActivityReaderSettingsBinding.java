...
public final class ActivityReaderSettingsBinding implements ViewBinding {
  ...
  @NonNull
  public final Spinner rfPowerSpinner;
  ...
  private ActivityReaderSettingsBinding(@NonNull ScrollView rootView,
      ...
      @NonNull TextView readerIpText, @NonNull Spinner rfPowerSpinner,
    ...
    this.rfPowerSpinner = rfPowerSpinner;
  ...
  public static ActivityReaderSettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.rfPowerSpinner;
      Spinner rfPowerSpinner = ViewBindings.findChildViewById(rootView, id);
      if (rfPowerSpinner == null) {
        break missingId;
      }
      ...
      return new ActivityReaderSettingsBinding((ScrollView) rootView, currentRfPowerLabel,
          ...
          rfPowerSpinner, setButton, statusText, titleText);
    }
