...
public final class ActivitySplashBinding implements ViewBinding {
  ...
  private ActivitySplashBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView bgImage,
      @NonNull ImageView logoImage, @NonNull LottieAnimationView lottieView) {
  ...
  public static ActivitySplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySplashBinding((ConstraintLayout) rootView, bgImage, logoImage, lottieView);
    }
